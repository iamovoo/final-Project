<template>
      ...
      >
        ...
        >
          <div class="flex items-center h-[28px] gap-[4px] justify-center">
            ...
            <div
              class="w-[23px] h-[25px] bg-[#FCEFE9] rounded-[16px] text-[#B34C19] text-[12px] p-[4px]"
            >
              20
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div
              class="h-[32px] w-[288px] flex justify-between items-center pr-3"
            >
              <div
                class="text-[#B34C19] text-[12px] bg-[#FCEFE9] py-[2px] pl-[6px] pr-[8px]"
              >
                Almost Burnt Out
              </div>
              <button
                class="flex gap-[6px] items-center justify-center text-[#2F7DD0] text-[14px] border border-[#ACCBEC]"
              >
                <img
  ...
  <div class="block md:hidden">
    <div
      class="fixed top-0 bottom-0 left-0 right-0 bg-black bg-opacity-50 flex justify-center items-end"
    >
      <div
        class="w-[375px] h-[404px] bg-[#FFFFFF] rounded-t-[12px] p-[20px] flex flex-col gap-[16px]"
      >
        <div
          class="w-[335px] h-[36px] pb-[12px] flex justify-between items-center border-[#F0F2F5]"
        >
          <div class="flex items-center h-[28px] gap-[4px] justify-center">
            <h6
              class="text-[#1D2739] text-[20px] flex font-semibold items-center"
        ...
        >
          ...
          >
            ...
            <button
              class="flex gap-[6px] items-center justify-center text-[#2F7DD0] text-[14px] border border-[#ACCBEC] h-[32px] w-[335px] rounded-[4px]"
            >
              <img
                src="/assets/icons/ArrowUpRight.png"
                alt=""
